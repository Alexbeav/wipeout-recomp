...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/wipeout-recomp/total)](https://github.com/Alexbeav/wipeout-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/wipeout-recomp/latest/total)](https://github.com/Alexbeav/wipeout-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/wipeout-recomp)](https://github.com/Alexbeav/wipeout-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **WipEout** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

WipEout recompiled for modern systems using psxrecomp.
...
The current package is not release-ready. The owned Track 01 identity did not
...
Zip prefix for CI artifacts: `wipeout-recomp`.
